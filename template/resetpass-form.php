                ...
                <div class="card-body">
                    <form action="./login.php" method="post">
                        <div class="input-group form-group">
                            ...
                            <input type="text" name="resetUsername" class="form-control" placeholder="Email" maxlength="29" required>
                        </div>
                        <div class="input-group form-group">
                            <div class="input-group-prepend">
                            ...
                            <input type="password" name="newPassword" class="form-control" placeholder="New Password" maxlength="29" required>
                        </div>
                        <small class="form-text text-center text-muted mb-4">
                            Insert a new password
                        </small>
                        <div class="form-group">
                            <input type="submit" value="Reset" class="btn btn-light float-right login_btn">
                        </div>
                    </form>
                </div>
            </div>
