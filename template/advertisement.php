...
<div id="Advertisement" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="<?php echo UPLOAD_ADVERTISEMENT;?>la.jpg" alt="Concerto Los Angeles">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="<?php echo UPLOAD_ADVERTISEMENT;?>chicago.jpg" alt="Concerto Chicago">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="<?php echo UPLOAD_ADVERTISEMENT;?>ny.jpg" alt="Concerto New York">
        </div>
    </div>
